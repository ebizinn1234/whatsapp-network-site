...
async function loadGroups() {
    ...
    try {
        ...
        // Usar a API correta do Baileys para buscar chats reais
        ...
        // Método alternativo usando eventos
        try {
            // Aguardar eventos de chats
            await new Promise(resolve => setTimeout(resolve, 3000));
            
            // Se ainda não funcionou, usar dados mockados como fallback
            const mockGroups = [
